...
extern enum ele7en_status registerInlineHook(uint32_t target_addr, uint32_t new_addr, uint32_t **proto_addr);
extern enum ele7en_status inlineUnHook(uint32_t target_addr);
extern void inlineUnHookAll();
extern enum ele7en_status inlineHook(uint32_t target_addr);
extern void inlineHookAll();
